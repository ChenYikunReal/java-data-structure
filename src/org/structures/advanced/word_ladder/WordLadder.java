package org.structures.advanced.word_ladder;
...
public class WordLadder {
    ...
    // Returns true is word1 and word2 are the same length and differ in only one character.
    ...
    // user instead call computeAdjacentWords once and then call other findChar for each word pair.
