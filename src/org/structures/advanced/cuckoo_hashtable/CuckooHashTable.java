...
public class CuckooHashTable<T> {
     ...
     */
    public CuckooHashTable(IHashTable<? super T> hf) {
     ...
     */
    public CuckooHashTable(IHashTable<? super T> hf, int size) {
    ...
    public static void main( String [ ] args ) {
        ...
        for( int att  = 0; att < ATTEMPTS; att++ ) {
            ...
            CuckooHashTable<String> H = new CuckooHashTable<>( new StringHashTable( 3 ) );
