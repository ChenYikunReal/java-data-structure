...
public class CuckooHashTableClassic<AnyType>
{
     ...
     */
    public CuckooHashTableClassic( IHashTable<? super AnyType> hf )
    {
     ...
     */
    public CuckooHashTableClassic( IHashTable<? super AnyType> hf, int size )
    {
        hashFunctions = hf;
    ...
    private final IHashTable<? super AnyType> hashFunctions;
